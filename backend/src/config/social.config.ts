...
export const oauthConfigs: OAuthProviderConfigs = {
  google: {
...
export const shareConfigs: Record<string, ShareConfig> = {
  facebook: {
...
export const referralRewardTiers: ReferralRewardTier[] = [
